      ...
      <div className="flex justify-center items-center min-h-screen relative">
        ...
        <div className="w-100  relative z-10">
          <div className="w-full ">
            <div className=" bg-neutral-200 rounded-tl-[56px]   py-3 text-center absolute left-0  w-1/2 top-0  ">
              <h2 className=" text-zic-600 font-bold">  شماره همراه  </h2>
            </div>
            <div className="bg-cyan-400 text-white  rounded-tr-[56px]   py-3 text-center absolute right-0  w-1/2 top-0 ">
            <a href="./loginUser" target="_parent"   rel="noopener noreferrer"><h2 className=" font-bold">نام کاربری</h2></a>
          </div>
          </div>
